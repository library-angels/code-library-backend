...
/// ```
pub fn get_book_by_id(book_id: Uuid) -> QueryResult<RawBookAndArgs> {
    books::table
        .find(book_id)
...
/// ```
pub fn get_book_authors(book_id: Uuid) -> QueryResult<Vec<Person>> {
    books_authors::table
...
/// ```
pub fn get_book_series(book_id: Uuid) -> QueryResult<Option<Series>> {
    books_series::table
...
/// ```
pub fn get_book_subject_areas(book_id: Uuid) -> QueryResult<Vec<SubjectArea>> {
...
/// ```
pub fn get_authors_of_book_list(book_ids: &[Uuid]) -> QueryResult<Vec<(Uuid, Person)>> {
    books_authors::table
...
/// ```
pub fn get_series_of_book_list(book_ids: &[Uuid]) -> QueryResult<Vec<(Uuid, Series)>> {
    books_series::table
...
/// ```
pub fn get_subject_areas_of_book_list(book_ids: &[Uuid]) -> QueryResult<Vec<(Uuid, SubjectArea)>> {
    books_subject_areas::table
